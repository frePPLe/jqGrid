# maintained fork of free-jqGrid
...
- As a long-time & happy user of jqgrid this repository aims at maintaining a working version of
  ...
  and full-featured grid plugin.

### New main features implemented after version 4.15.5:

* Column names in the search dialog are sorted alphabetically. This improves usability when dealing
  with many columns in the grid.
